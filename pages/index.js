  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          name="description"
          content="⚽ باشگاه فرهنگی ورزشی دلفین گربدان ⚽ 
        ...
        <meta
          name="keywords"
          content="باشگاه فوتبال دلفین گربدان , تیم فوتبال قشم , تیم دلفین گربدان"
        />
      </Head>
              ...
              <Col className={styles.hom2} sm={5}>
                ...
                >
                  <p className={styles.txtdolfin}>
                    باشگاه فوتبال دلفین گربدان یکی از پر افتخارترین و پر
                    هوادارترین باشگاه های فوتبال در جزیره قشم است دلفین گربدان
                    پیش از انقلاب ستاره جنوب گربدان نام داشت باشگاه هم اکنون در
                    لیگ دسته دو قشم قرار گرفته , دلفین گربدان در سال 1324 در
                    جزیره قشم روستای گربدان بنیان گذاری شده است
                  </p>
                </motion.div>
              </Col>
            </Row>
